...
9. Create controls in WM_CREATE msg. Here "listbox" control is added.

10.There is predefined standard class "listbox" which is registered by the system.

11.Use CreateWindowEx() with "listbox" as class. specify its location and other parameters.

12.All List box's have unique id assigned to them.
