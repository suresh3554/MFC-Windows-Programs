...
9. Create controls in WM_CREATE msg. Here "Combobox" control is added.

10.There is predefined standard class "Combobox" which is registered by the system.

11.Use CreateWindowEx() with "Combobox" as class. specify its location and other parameters.

12.Here 3 different types of buttons are created. 
      - Simple  > use style "CBS_SIMPLE"
      - DropDown > use style "CBS_DROPDOWN"
      - DropDownList > use style "CBS_DROPDOWNLIST"

13.All Combobox's have unique id assigned to them.
