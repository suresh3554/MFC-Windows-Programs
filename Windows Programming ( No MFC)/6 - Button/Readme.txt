...
9. Create controls in WM_CREATE msg. Here Button control is added.

10.There is predefined standard class "Button" which is registered by the system.

11.Use CreateWindowEx() with "Button" as class. specify its location and other parameters.

12.Here 4 different types of buttons are created. 
      - Groupbox  > use style "BS_GROUPBOX"
      - PushButton > use style "BS_DEFPUSHBUTTON"
      - Checkbox > use style "BS_AUTOCHECKBOX"
      - Radio > use style "BS_AUTORADIOBUTTON"

13.All buttons have unique id assigned to them.

14.Notification message from standard control to user is WM_COMMAND.

15.wParam 
      - Lo word is ID of the control
      - Hi word is notification code

16.lparam - contains the handle to the control
