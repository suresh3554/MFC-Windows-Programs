...
9. Create controls in WM_CREATE msg. Here "edit" control is added.

10.There is predefined standard class "edit" which is registered by the system.

11.Use CreateWindowEx() with "edit" as class. specify its location and other parameters.

12.Here 2 different types of Edit boxes are created. 
      - Normal text box 
      - Password style text box > use style "ES_PASSWORD"

13.All Edit box's have unique id assigned to them.
